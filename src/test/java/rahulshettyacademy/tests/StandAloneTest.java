...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("ajaychy5602@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("L0$tman@123");
		...
		driver.findElement(By.xpath("//button[contains(@class,'ta-item list-group-item ng-star-inserted')][2]"))
				.click();
